import { r as requireLib, a as requireUndici, g as getDefaultExportFromCjs, b as getAugmentedNamespace, c as coreExports } from './core-D1vDSATZ.js';
...
async function run() {
  try {
    ...
    coreExports.info(`Using version ${version}`);
    coreExports.info(
